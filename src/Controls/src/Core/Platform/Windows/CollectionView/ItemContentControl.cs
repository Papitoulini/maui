...
namespace Microsoft.Maui.Controls.Platform
{
	public class ItemContentControl : ContentControl
	{
		...
		{
			// if the view implements ICrossPlatformLayout we don't need to do anything
			// because the platform view will have already called IView.Arrange
			if (_handler != null && _visualElement is IView view && view is not ICrossPlatformLayout)
			{
		...
		protected override WSize MeasureOverride(WSize availableSize)
		{
			...
			// if the view implements ICrossPlatformLayout we don't need to do anything
			// because the platform view will have already called IView.Measure
			if (_visualElement is IView view && view is not ICrossPlatformLayout)
			{
